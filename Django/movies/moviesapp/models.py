...
class Movie(models.Model):
    ...
    actors = models.ManyToManyField(Actor, verbose_name="жанры")
    genres = models.ManyToManyField(Genre, verbose_name="жанры", related_name="film_genre")
    world_premiere = models.DateField("Примьера в мире", auto_now_add = False)
    ...
    def get_absolute_url(self):
        return reverse("moviesapp:movie_detail", kwargs={"slug": self.url})
...
class Reviews(models.Model):
    ...
    movie = models.ForeignKey(Movie, verbose_name="фильм",related_name="reviews", on_delete=models.CASCADE)
